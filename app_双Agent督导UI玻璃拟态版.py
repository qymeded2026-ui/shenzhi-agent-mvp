...
def inject_custom_css():
    ...
    st.markdown(
        ...
        [data-testid="stSidebar"] {
            background: linear-gradient(180deg, #F4FAF9 0%, #F8FAFC 48%, #FFFFFF 100%);
            border-right: 1px solid rgba(27, 75, 86, 0.12);
            box-shadow: 10px 0 28px rgba(20, 70, 80, 0.055);
        }
        ...
        .sidebar-logo img {
            ...
            height: auto;
            display: block;
            filter: drop-shadow(0 12px 18px rgba(23, 76, 91, 0.12));
        }
        ...
        .sidebar-footer {
            ...
            border: 1px solid rgba(31, 113, 108, 0.12);
            color: #587078;
            font-size: 0.72rem;
            line-height: 1.55;
            box-shadow: 0 12px 24px rgba(20, 70, 80, 0.055);
        }
        ...
        [data-testid="stSidebar"] .stButton > button {
            ...
            box-shadow: 0 3px 10px rgba(20, 70, 80, 0.035);
        }
        ...
        .current-case-pill {
            ...
            box-shadow: 0 8px 18px rgba(20, 70, 80, 0.055);
        }
        ...
        .score-tile {
            border-radius: 8px;
            border: 1px solid rgba(42, 98, 94, 0.11);
            background: linear-gradient(180deg, #FFFFFF 0%, #F8FBFA 100%);
            padding: 0.58rem 0.62rem;
            box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.95), 0 8px 18px rgba(20, 70, 80, 0.04);
        }
        .score-value {
            font-size: 1.28rem;
            font-weight: 850;
        ...
        div[data-testid="stForm"] {
            border-radius: 8px;
            border-color: rgba(42, 98, 94, 0.14);
            background: #FFFFFF;
            box-shadow: 0 12px 28px rgba(20, 70, 80, 0.06);
        }
        ...
        div[data-testid="stExpander"] {
            border-radius: 8px;
            background: #FFFFFF;
            box-shadow: 0 10px 24px rgba(20, 70, 80, 0.055);
        }
        div[data-testid="stVerticalBlockBorderWrapper"] {
            border-color: rgba(42, 98, 94, 0.13);
            background: #FFFFFF;
            box-shadow: 0 14px 32px rgba(20, 70, 80, 0.055);
        }
        .supervisor-top-spacer {
            height: 1.05rem;
        }
        ...
        html, body, [data-testid="stAppViewContainer"], .stApp {
            background:
                radial-gradient(circle at 7% 8%, rgba(154, 203, 198, 0.28), transparent 27%),
                radial-gradient(circle at 92% 12%, rgba(205, 194, 225, 0.34), transparent 28%),
                linear-gradient(135deg, #EEF4F6 0%, #F8FAFC 45%, #F3EEF8 100%) !important;
        }
        ...
        [data-testid="stSidebar"] {
            background: rgba(247, 251, 251, 0.62) !important;
            backdrop-filter: blur(24px);
            -webkit-backdrop-filter: blur(24px);
            border-right: 1px solid rgba(255, 255, 255, 0.72) !important;
            box-shadow: 20px 0 48px rgba(31, 48, 66, 0.10) !important;
        }

        [data-testid="stSidebar"] > div:first-child {
            padding: 1.6rem 1.05rem 1.2rem 1.05rem;
        }

        .sidebar-logo {
            padding: 0.18rem 0 1.25rem 0 !important;
        ...
        .sidebar-logo img {
            ...
            filter: drop-shadow(0 18px 24px rgba(18, 59, 70, 0.16)) !important;
        }
        ...
        [data-testid="stSidebar"] .stButton > button {
            ...
            box-shadow:
                ...
                0 10px 24px rgba(31, 48, 66, 0.07) !important;
        }

        [data-testid="stSidebar"] .stButton > button:hover {
            background: rgba(255, 255, 255, 0.66) !important;
            border-color: rgba(42, 98, 94, 0.18) !important;
            color: #123B46 !important;
        }

        [data-testid="stSidebar"] .stButton > button[kind="primary"] {
            background: linear-gradient(135deg, #0F3F51 0%, #167970 100%) !important;
            color: #FFFFFF !important;
            border: 1px solid rgba(255, 255, 255, 0.25) !important;
            box-shadow: 0 16px 32px rgba(15, 63, 81, 0.22) !important;
        }

        [data-testid="stSidebar"] input {
            background: rgba(255, 255, 255, 0.78) !important;
            border: 1px solid rgba(255, 255, 255, 0.92) !important;
            box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.96), 0 8px 18px rgba(31, 48, 66, 0.045) !important;
        }
        ...
        .sidebar-footer {
            background: linear-gradient(145deg, rgba(239, 250, 247, 0.72), rgba(255, 255, 255, 0.54)) !important;
            border: 1px solid rgba(255, 255, 255, 0.74) !important;
            box-shadow: 0 18px 34px rgba(31, 48, 66, 0.075) !important;
        }

        .current-case-pill {
            background: rgba(236, 249, 247, 0.72) !important;
            color: #255F61 !important;
            border: 1px solid rgba(255, 255, 255, 0.82) !important;
            box-shadow: 0 14px 28px rgba(31, 48, 66, 0.07) !important;
        ...
        .supervisor-panel {
            ...
            border: 1px solid rgba(255, 255, 255, 0.78) !important;
            background:
                linear-gradient(145deg, rgba(255, 255, 255, 0.78), rgba(244, 247, 252, 0.48)) !important;
            backdrop-filter: blur(22px);
            -webkit-backdrop-filter: blur(22px);
            box-shadow:
                inset 0 1px 0 rgba(255, 255, 255, 0.95),
                0 18px 42px rgba(31, 48, 66, 0.085) !important;
        }
        ...
        div[data-testid="stForm"] textarea {
            ...
            background: rgba(244, 247, 252, 0.84) !important;
        ...
        .stButton > button {
            ...
            box-shadow: 0 12px 24px rgba(31, 48, 66, 0.075) !important;
        }

        .stButton > button:hover {
            border-color: rgba(42, 98, 94, 0.22) !important;
            box-shadow: 0 16px 30px rgba(31, 48, 66, 0.11) !important;
            transform: translateY(-1px);
        }

        .score-tile {
            background: linear-gradient(145deg, rgba(255, 255, 255, 0.76), rgba(248, 250, 252, 0.56)) !important;
            border: 1px solid rgba(255, 255, 255, 0.74) !important;
            box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.9), 0 12px 24px rgba(31, 48, 66, 0.06) !important;
        }
        ...
        .next-step-box {
            background: linear-gradient(135deg, rgba(255, 249, 241, 0.84), rgba(246, 231, 210, 0.46)) !important;
            border-left: 3px solid #B57A42 !important;
        ...
        .agent-bubble-supervisor {
            background: rgba(236, 249, 247, 0.74) !important;
...
def render_chat_sidebar(default_case_title: str):
    ...
    with st.sidebar:
        ...
        if os.path.exists(logo_path):
            st.markdown(
                f"<div class='sidebar-logo'><img src='{read_svg_as_data_uri(logo_path)}' alt='神志思训 logo'><div class='sidebar-logo-title'>神志思训</div></div>",
                unsafe_allow_html=True,
            )
...
with left:
    st.markdown("<div class='page-title'>问诊区</div>", unsafe_allow_html=True)
...
with right:
    ...
    st.markdown("<div class='supervisor-top-spacer'></div>", unsafe_allow_html=True)
    st.markdown("<div class='right-title'>督导老师</div>", unsafe_allow_html=True)
    ...
    with st.expander("历史反馈", expanded=False):
        with st.container(height=140, border=False):
            if supervisor_history:
                for item in supervisor_history[-8:]:
                    st.markdown(
